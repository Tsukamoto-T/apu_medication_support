...
IdentifyCalendar::IdentifyCalendar(){
  ...
  pub_pocket_points = nh.advertise<sensor_msgs::PointCloud2>("cloud_target_points", 1);
...
void IdentifyCalendar::CloudCb(const sensor_msgs::PointCloud2ConstPtr &cloud_msg) {
  ...
  present_point.z = upper_left_point.z - 0.03;
  ...
  present_point_dr.x = present_point.x + 0.085;
  present_point_dr.y = present_point.y + 0.015;
